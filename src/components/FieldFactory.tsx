...
const FieldFactory = ({
  ...
  const ancestorValueList = [textAncestorValue, booleanAncestorValue, objectAncestorValue, arrayAncestorValue];
  const ancestorValueToConsume = ancestorValueList.find((v) => v !== undefined) ?? "";
